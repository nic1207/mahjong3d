...
public class RPCMan : Player 
{
	//public RPCMan(string name) : base(name){
    //    
    //}
	//public RPCMan(string name, EVoiceType voiceType) : base(name, voiceType){
	//
    //}
